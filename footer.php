...
<footer class="bg-tarmac-black text-overcast-white border-t-4 border-secondary">
    <div class="grid grid-cols-1 md:grid-cols-3 gap-gutter px-margin-mobile md:px-margin-desktop py-12 max-w-container-max mx-auto text-center md:text-left">
        <div class="space-y-4">
            ...
            <?php $footer_address = zeintyres_get_contact_field('zeintyres_contact_address', null, '12-14 Motto Dr, Coolaroo VIC 3048'); ?>
    ...
    <div class="border-t border-surface-variant/20 py-6 text-center">
        <p class="font-body-md text-body-md text-steel-gray text-sm">© <?php echo date('Y'); ?> Zein Tyres &amp; Wheels Melbourne. Professional Mobile Tyre Service.</p>
    </div>
</footer>
<?php wp_footer(); ?>
</body>
